...
class SignApk {
    ...
    private static Manifest addDigestsToManifest(JarFile jar)
        ...
        for (JarEntry entry: byName.values()) {
            ...
            if (!entry.isDirectory() && !name.equals(JarFile.MANIFEST_NAME) &&
                ...
                attr.putValue("SHA1-Digest", encoder.encodeToString(md.digest()));
    ...
    private static void writeSignatureFile(Manifest manifest, SignatureOutputStream out)
        ...
        print.flush();
        main.putValue("SHA1-Digest-Manifest", encoder.encodeToString(md.digest()));
        ...
        for (Map.Entry<String, Attributes> entry : entries.entrySet()) {
            ...
            sfAttr.putValue("SHA1-Digest", encoder.encodeToString(md.digest()));
