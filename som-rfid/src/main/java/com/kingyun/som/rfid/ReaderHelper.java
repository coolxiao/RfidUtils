...
import com.kingyun.som.rfid.base.CMD;
import com.kingyun.som.rfid.base.ERROR;
import com.kingyun.som.rfid.base.HEAD;
import com.kingyun.som.rfid.base.MessageTran;
import com.kingyun.som.rfid.base.ReaderBase;
import com.kingyun.som.rfid.base.StringTool;
import com.kingyun.som.rfid.helper.ISO180006BOperateTagBuffer;
import com.kingyun.som.rfid.helper.InventoryBuffer;
import com.kingyun.som.rfid.helper.OperateTagBuffer;
...
public class ReaderHelper {
	...
	public static void setContext(Context context) {
		...
		if (context == null) {
			...
			m_curInventoryBuffer = null;
			m_curOperateTagBuffer = null;
			m_curOperateTagISO18000Buffer = null;
			mReaderHelper = null;
		} else {
     ...
     */
	static ReaderHelper getDefaultHelper() throws NullPointerException {
	 ...
	 */
	ReaderBase setReader(InputStream in, OutputStream out) throws NullPointerException {
	 ...
	 */
	public ReaderBase getReader() throws NullPointerException {
		if (mReader == null) {
	...
	private String getFreqString(byte btFreq) {
        if (m_curReaderSetting.btRegion == 4) {
            ...
            float nstartFrequency = (float)(m_curReaderSetting.nUserDefineStartFrequency & 0xFF) / 1000;
            ...
            if ((btFreq & 0xFF) < 0x07) {
            	float nStart = 865.00f + (float)(btFreq & 0xFF) * 0.5f;
            	String strTemp = String.format("%.2f", nStart);

                return strTemp;
            } else {
            	float nStart = 902.00f + ((float)(btFreq & 0xFF) - 7) * 0.5f;
            	String strTemp = String.format("%.2f", nStart);
